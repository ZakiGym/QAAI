      ...
      <main className="mx-auto max-w-5xl px-6 py-16">
        ...
        <section id="how" className="mb-24">
          <h2 className="mb-3 text-2xl font-semibold tracking-tight">
            It never silently self-heals
          </h2>
          <p className="text-ink-dim mb-8 max-w-2xl">
            Every failure gets a verdict, a confidence score, and evidence you can check. What
            happens next is your call — not the model&rsquo;s.
          </p>
